(function($) {
  ...
  $.extend({
    ...
    klazz: function() {
      ...
      klazz.superclass = parent;
      klazz.subclasses = [];
      klazz.addMethods = addMethods;

      if (parent) {
        var subclass = function() { };
        subclass.prototype = parent.prototype;
        klazz.prototype = new subclass;
        parent.subclasses.push(klazz);
      }

      for (var i = 0; i < properties.length; i++)
        klazz.addMethods(properties[i]);

      if (!klazz.prototype.initialize)
        klazz.prototype.initialize = function() {};
